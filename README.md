...
2. Download the images from [Galaxy Zoo classification](https://www.kaggle.com/datasets/anjosut/galaxy-zoo-classification). Place them in a `Train_images` folder in the same directory as the notebook.
