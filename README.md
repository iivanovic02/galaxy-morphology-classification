...
2. Download the images from [Galaxy Zoo classification](https://www.kaggle.com/datasets/anjosut/galaxy-zoo-classification) and place them in the `Train_images` folder.
